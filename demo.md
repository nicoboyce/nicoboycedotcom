...
<style>
  ...
  /* Frame-specific poses - Overlapping Leg Sequence Walk */
  /* Frame 1: FL forward peak, BL finishing back */
  ...
  .frame-1 .body { transform: translateX(-50%) translateY(-4px); }
  .frame-1 .note { opacity: 0.6; transform: scale(1.05); }
  ...
  .frame-2 .note { opacity: 0.5; transform: scale(1); }

  /* Frame 3: FL back, BR moving forward */
  ...
  .frame-3 .body { transform: translateX(-50%) translateY(-3px); }
  .frame-3 .note { opacity: 0.5; transform: scale(0.95); }

  /* Frame 4: BR forward peak, FL finishing back */
  ...
  .frame-4 .body { transform: translateX(-50%) translateY(-4px); }
  .frame-4 .note { opacity: 0.6; transform: scale(1.05); }
  ...
  .frame-5 .body { transform: translateX(-50%) translateY(-3px); }
  .frame-5 .note { opacity: 0.5; transform: scale(1); }

  /* Frame 6: BR back, FR moving forward */
  ...
  /* Frame 7: FR forward peak, BR finishing back */
  ...
  .frame-7 .body { transform: translateX(-50%) translateY(-4px); }
  .frame-7 .note { opacity: 0.6; transform: scale(1.05); }
  ...
  .frame-8 .note { opacity: 0.5; transform: scale(1); }

  /* Frame 9: FR back, BL moving forward */
  ...
  .frame-9 .body { transform: translateX(-50%) translateY(-3px); }
  .frame-9 .note { opacity: 0.5; transform: scale(0.95); }

  /* Frame 10: BL forward peak, FR finishing back */
  ...
  .frame-10 .body { transform: translateX(-50%) translateY(-4px); }
  .frame-10 .note { opacity: 0.6; transform: scale(1.05); }
  ...
  .frame-11 .body { transform: translateX(-50%) translateY(-3px); }
  .frame-11 .note { opacity: 0.5; transform: scale(1); }

  /* Frame 12: BL back, FL moving forward */
  ...
  .frame-12 .body { transform: translateX(-50%) translateY(-3px); }
